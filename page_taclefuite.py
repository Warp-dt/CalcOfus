...
st.caption("Logique et formules détaillées [ici](http://localhost:8501/formulofus#5-tacle-fuite)")
...
| ----------- | ----------- |
"""
tab_res+=f"""| {round(pm-(pm*ptot))}{alerte_full_tacle} | {round(pa-(pa*ptot))} |"""
